...
export default function CreateLoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // For demo, simulate checking if user exists
    const userExists = false // In real app, check database
    
    if (!userExists) {
      // User not found, show alert and redirect to register
      alert('Akun tidak ditemukan. Silakan daftar terlebih dahulu.')
      router.push('/create/register')
    } else {
      // User exists, continue to select category
        ...
        <div className="container mx-auto px-4 max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">
              Masuk untuk mulai tolong-menolong sesama
            </h2>
            <p className="text-sm text-gray-600 mb-6">
              Login atau daftar untuk membuat campaign
            </p>
